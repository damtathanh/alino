      ...
      <div className="hidden lg:flex lg:w-[40%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-start px-12 xl:px-16 w-full">
          ...
          <p className="text-base text-[#6B7280] leading-relaxed">
            Đăng nhập để tiếp tục quản lý các dự án hợp tác của bạn
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[60%] flex items-center justify-center p-6 overflow-y-auto bg-white">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end">
              <Link
                ...
                className="text-sm text-[#6366F1] hover:text-[#4338CA] transition-colors"
              >
                Quên mật khẩu?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-[#6B7280]">
            Chưa có tài khoản?{' '}
            <Link href="/signup" className="text-[#6366F1] hover:text-[#4338CA] font-medium transition-colors">
              Đăng ký
            </Link>
          </div>
        </div>
